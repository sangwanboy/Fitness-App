<!--
  ...
  App Store Connect / the App Description links to it, and LoginView links to
  it in-app too. Content is mirrored, in plain Swift string form, in
  Services/Legal/LegalTexts.swift (LegalTexts.terms) — keep both in sync when
  either changes.
-->
...
Questions about these terms? Email [team@atlasjob.tech](mailto:team@atlasjob.tech).
